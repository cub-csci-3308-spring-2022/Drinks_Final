...
// get to route our login to login.HTML
app.get('/', function(request, response) {
	// Render login template
	response.sendFile(path.join(__dirname + '/login.html'));
});

// Heart of login page -> verify user info with post
...
// emily 
//api
app.post('/ingredients/search', function(req,res){
